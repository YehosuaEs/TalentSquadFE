...
import { Cuerpo, Title, CenterSection, Card, CardInfo, Type, TypeCointaner, CartTitles, Text, StatsContainer, Iconos, Container, About, Info, Skills, SkillsNum, SkillsBar, StatsDetails } from "./loading_styles";
                    ...
                    <CardInfo>
                        ...
                        <StatsContainer>
                            <StatsDetails>
                                ...
                                <SkillsBar><progress value="45" max="100"/></SkillsBar>
                            </StatsDetails>
                            <StatsDetails>
                                <Skills>ATK</Skills>
                                <SkillsNum >049</SkillsNum>
                                <SkillsBar><progress value="49" max="100"/></SkillsBar>
                            </StatsDetails> 
                            <StatsDetails>
                                <Skills>DEF</Skills>
                                <SkillsNum >049</SkillsNum>
                                <SkillsBar><progress value="049" max="100"/></SkillsBar>
                            </StatsDetails> 
                            <StatsDetails>
                                <Skills>SATK</Skills>
                                <SkillsNum >049</SkillsNum>
                                <SkillsBar><progress value="65" max="100"/></SkillsBar>
                            </StatsDetails> 
                            <StatsDetails>
                                <Skills>SDEF</Skills>
                                <SkillsNum >049</SkillsNum>
